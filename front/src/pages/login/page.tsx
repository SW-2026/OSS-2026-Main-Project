        ...
        <div className="bg-[#111] border border-[#222] rounded-2xl p-8">
          ...
          <p className="text-center text-xs text-[#555] mt-5">
            {mode === "login" ? (
              <>
                계정이 없으신가요?{" "}
                <button onClick={() => switchMode("signup")} className="text-orange-400 hover:text-orange-300 cursor-pointer">
                  회원가입
                </button>
              </>
            ) : (
              <>
                이미 계정이 있으신가요?{" "}
                <button onClick={() => switchMode("login")} className="text-orange-400 hover:text-orange-300 cursor-pointer">
                  로그인
                </button>
              </>
            )}
