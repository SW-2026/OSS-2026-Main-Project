...
const toolGroups: { tools: { id: DrawingTool; icon: string; label: string; shortcut: string }[] }[] = [
  ...
  {
    tools: [
      { id: "text", icon: "ri-text", label: "텍스트 (T)", shortcut: "T" },
      { id: "balloon", icon: "ri-chat-1-line", label: "말풍선 (W)", shortcut: "W" },
    ],
  },
  {
    tools: [
      { id: "eyedropper", icon: "ri-eye-2-line", label: "스포이드 (I)", shortcut: "I" },
